 ...
 */
export type FrameworkType = 'RICE' | 'MoSCoW' | 'ValueEffort' | 'ICE' | 'Eisenhower' | 'P0P4' | 'WSJF' | 'Kano';
/**
 ...
 */
export type KanoCategory = 'MustBe' | 'OneDimensional' | 'Attractive' | 'Indifferent' | 'Reverse' | 'Questionable';
/**
