 ...
 * Values: KanoCategory
 */
export const KANO_EVALUATION_MATRIX = {
    // Functional: Like (5)
    '5,5': 'Questionable',
    '5,4': 'Attractive',
    '5,3': 'Attractive',
 ...
 */
export const KANO_CATEGORY_SCORES = {
    MustBe: 1,
    OneDimensional: 2,
    Attractive: 3,
    Indifferent: 0,
...
export class KanoCalculator {
    ...
    constructor(config = DEFAULT_CONFIG) {
        ...
        Object.defineProperty(this, "includeCoefficients", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    validate(input) {
        ...
        if (input.functionalScore !== undefined &&
            ...
            if ((input.functionalScore === 5 && input.dysfunctionalScore === 5) ||
    ...
    normalize(result, allResults) {
        ...
        const rank = sortedResults.findIndex((r) => r.category === result.category && r.functionalScore === result.functionalScore) + 1;
        ...
        if (maxScore === minScore) {
            ...
            normalizedScore = parseFloat((((KANO_CATEGORY_SCORES[result.category] - minScore) / (maxScore - minScore)) * 100).toFixed(this.decimalPlaces));
        }
        return {
            normalizedScore,
            rank,
    ...
    getAutoFillSuggestions(item) {
        ...
        let likelyCategory = 'Indifferent';
     ...
     * @private
     */
    determineCategory(functionalScore, dysfunctionalScore) {
     ...
     * @private
     */
    calculateSatisfactionCoefficient(functionalScore) {
     ...
     * @private
     */
    calculateDissatisfactionCoefficient(dysfunctionalScore) {
     ...
     * @private
     */
    getCategoryInterpretation(category) {
 ...
 * ```
 */
export function createKanoCalculator(config = {}) {
