...
export class AutoFillEngine {
    ...
    constructor(config = {}) {
        ...
        Object.defineProperty(this, "labelAnalyzer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "metricsExtractor", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    generateRICESuggestions(_item, patternMatches, metrics) {
        const suggestions = [];
        // Reach suggestion
        ...
        if (confidenceMatch) {
            suggestions.push({
                ...
                source: 'pattern',
                reason: `Detected "${confidenceMatch.keyword}" suggesting ${confidenceMatch.suggestedValue}% confidence`
            });
        }
        else {
            suggestions.push({
     ...
     */
    generateMoSCoWSuggestions(item, patternMatches) {
        const suggestions = [];
     ...
     */
    generateValueEffortSuggestions(_item, patternMatches, metrics) {
        const suggestions = [];
        // Value suggestion
     ...
     */
    generateEisenhowerSuggestions(item, patternMatches) {
        const suggestions = [];
        ...
        if (eisenhowerMatch && typeof eisenhowerMatch.suggestedValue === 'object') {
            const value = eisenhowerMatch.suggestedValue;
     ...
     */
    generateP0P4Suggestions(_item, patternMatches) {
        const suggestions = [];
